...
//   // Note: We use initialOrders here as the source of truth
...
//             className="bg-white w-full max-w-2xl rounded-[2.5rem] overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200"
//           >
//             <div className="bg-maroon-primary p-8 text-white flex justify-between items-start">
//               <div>
...
//             <div
//               className={`h-12 w-12 rounded-2xl mb-4 flex items-center justify-center ${confirmConfig.variant === "danger" ? "bg-red-50 text-red-500" : "bg-maroon-primary/10 text-maroon-primary"}`}
//             >
...
//                   setConfirmConfig({ ...confirmConfig, isOpen: false });
//                 }}
//                 className={`flex-1 px-4 py-3 rounded-xl text-sm font-bold text-white transition-all shadow-lg ${confirmConfig.variant === "danger" ? "bg-red-500 shadow-red-200 hover:bg-red-600" : "bg-maroon-primary shadow-maroon-primary/20 hover:opacity-90"}`}
//               >
//                 Confirm
//               </button>
//             </div>
