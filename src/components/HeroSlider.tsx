      ...
      {SLIDES.map((slide, index) => (
        ...
        >
          ...
          <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-6">
            ...
            <h2 className="text-4xl md:text-8xl font-black italic uppercase tracking-tighter mb-6 max-w-5xl leading-[0.9] animate-in fade-in slide-in-from-bottom-6 duration-1000">
              {slide.title}
            </h2>
