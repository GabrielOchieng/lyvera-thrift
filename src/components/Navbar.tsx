...
export default function Navbar() {
  ...
  // Click Outside Logic (Search & User Dropdown)
  useEffect(() => {
              ...
              <div className="relative">
                {isPending ? (
                  ...
                  <div className="relative" ref={userDropdownRef}>
                      ...
                      <div
                        className={`h-9 w-9 rounded-full flex items-center justify-center transition ${
                          isUserDropdownOpen
                            ...
                            : "bg-white/10 text-white group-hover:bg-thrift-gold/20"
                        }`}
                      >
                    ...
                    <div
                      className={`absolute right-0 mt-2 w-52 bg-white rounded-sm shadow-2xl py-2 text-zinc-800 transition-all duration-200 z-100 ${
                        isUserDropdownOpen
