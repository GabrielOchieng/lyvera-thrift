...
export const auth = betterAuth({
  ...
  emailAndPassword: {
    ...
    async sendResetPassword(data) {
      ...
      console.log(
        `[Lyvera Security] Initiating SMTP recovery for: ${user.email}`,
      );
      ...
      try {
              ...
              <div style="padding: 25px 40px; background-color: #ffffff;">
                ...
                <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #f1f5f9; text-align: center;">
                  ...
                  <p style="font-size: 10px; color: #94a3b8; text-transform: uppercase; tracking-widest;">
                    &copy; ${currentYear} Lyvera Thrifts &bull; Curating iconic looks
                  </p>
                </div>
              </div>
            </div>
        ...
        console.log(
          `[Lyvera Security] Recovery email sent successfully via SMTP.`,
        );
      } catch (err: any) {
