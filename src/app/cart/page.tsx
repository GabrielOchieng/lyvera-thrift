...
//     console.log("Final Order Package:", orderData);
//     alert(
//       `Thank you ${formData.name}! Order received. We will verify code ${formData.transCode} and call you.`,
//     );
...
//                 <div
//                   key={item.id}
//                   className="bg-white p-4 rounded-[2rem] border border-zinc-200 flex items-center gap-6 shadow-sm"
//                 >
//                   <img
//                     src={item.image}
...
//                   Summary
//                 </h2>
//                 <div className="flex justify-between text-xl font-black italic uppercase mb-8">
//                   <span>Total</span>
...
//                   className="w-full bg-maroon-primary text-white py-5 rounded-2xl font-black uppercase italic tracking-tighter hover:bg-thrift-gold hover:text-maroon-primary transition-all shadow-lg"
//                 >
//                   Checkout
//                 </button>
//               </div>
...
//             <Link
//               href="/"
//               className="text-maroon-primary font-bold underline mt-4 block"
//             >
//               Back to Shop
//             </Link>
//           </div>
...
//                   </div>
//                   <div className="relative">
//                     <Phone className="absolute left-4 top-4 h-5 w-5 text-zinc-400" />
//                     <input
//                       type="text"
...
//                     className="w-full bg-maroon-primary text-white py-5 rounded-2xl font-black uppercase italic tracking-tighter text-lg shadow-lg mt-4"
//                   >
//                     Next: Payment
//                   </button>
//                 </div>
...
//                   <div className="bg-zinc-900 text-white p-6 rounded-3xl text-center">
...
//                         })
//                       }
//                       className="w-full border-2 border-zinc-100 rounded-2xl p-4 text-center font-mono font-bold tracking-[0.3em] text-lg focus:border-maroon-primary outline-none transition-all"
//                     />
//                   </div>
...
//                       className="w-full bg-maroon-primary text-white py-5 rounded-2xl font-black uppercase italic tracking-tighter text-lg shadow-lg"
//                     >
//                       Confirm & Place Order
//                     </button>
//                     <button
