// import { Package, MoreVertical, Filter } from "lucide-react";
...
//   // Build the Prisma filter object using categoryId
//   const where: any = {};
//   if (category && category !== "all") {
//     // Normalizing to lowercase to match your database entries like "bottoms"
...
//             <Link
//               key={cat}
//               // URL uses the category name, logic converts to lower for categoryId
...
//                     {/* Displaying categoryId as the label */}
//                     {item.categoryId}
//                   </td>
...
//                     <button className="text-zinc-400 hover:text-maroon-primary transition-colors">
