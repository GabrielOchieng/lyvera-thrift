          ...
          >
            ...
            {showResults && (
              <div className="absolute top-full mt-2 w-full bg-white border border-zinc-200 rounded-xl shadow-2xl overflow-hidden max-h-[70vh] overflow-y-auto z-50">
                    ...
                    searchResults.products.map((product) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-bold text-zinc-900 truncate group-hover:text-maroon-primary transition-colors">
                            {product.name}
                          </p>
                ...
                {/* ORDERS SECTION */}
                <div className="p-2 border-y border-zinc-100 bg-zinc-50/50">
                  <p className="px-3 py-1 text-[10px] font-black uppercase tracking-widest text-zinc-400">
                    Orders
                  </p>
                </div>
                  ...
                  {searchResults.orders.length > 0 ? (
                    searchResults.orders.map((order) => (
                      <Link
                        ...
                        className="flex items-center gap-3 p-3 hover:bg-maroon-primary/5 transition-colors group"
                      >
                        <div className="h-10 w-10 rounded-full bg-maroon-primary/10 flex items-center justify-center text-maroon-primary shrink-0">
